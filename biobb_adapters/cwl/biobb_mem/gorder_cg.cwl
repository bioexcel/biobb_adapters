...
label: Wrapper of the gorder coarse-grained module for computing lipid order parameters
  per atom for carbon tails.

doc: |-
  gorder uses GSL for all its selections.

baseCommand: gorder_cg
...
inputs:
  input_top_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_mem/raw/main/biobb_mem/test/data/CG/cg_test.tpr
    type: File
    format:
    - edam:format_2333
    inputBinding:
  ...
  input_traj_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_mem/raw/main/biobb_mem/test/data/CG/cg_test.xtc
    type: File
    format:
    - edam:format_3875
    - edam:format_3910
  ...
  output_order_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_mem/raw/main/biobb_mem/test/reference/gorder/order_cg.yaml
    type: string
    format:
    - edam:format_3570
    - edam:format_2330
