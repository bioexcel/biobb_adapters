...
inputs:
  input_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_chemistry/raw/master/biobb_chemistry/test/data/babelm/babel.H.pdb
    type: File
    format:
    - edam:format_1637
    - edam:format_1476
  ...
  output_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_chemistry/raw/master/biobb_chemistry/test/reference/babelm/ref_babel.nohydrogens.pdb
    type: string
    format:
    - edam:format_1476
    - edam:format_1929
