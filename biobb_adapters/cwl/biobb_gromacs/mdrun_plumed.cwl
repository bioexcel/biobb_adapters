...
inputs:
  ...
  input_plumed_path:
    label: Path to the main PLUMED input file. If provided, PLUMED will be used during
      the simulation. All files used by the main PLUMED input file must exist in the
      input_plumed_folder and be called with just their name. Make sure to provide
      a GROMACS version with the PLUMED patch
    doc: |-
      Path to the main PLUMED input file. If provided, PLUMED will be used during the simulation. All files used by the main PLUMED input file must exist in the input_plumed_folder and be called with just their name. Make sure to provide a GROMACS version with the PLUMED patch
      Type: string
      File type: input
    ...
    - edam:format_2330
    inputBinding:
      prefix: --input_plumed_path

  input_plumed_folder:
    label: Path to the folder with all files needed by the main PLUMED input file,
    ...
    - edam:format_1915
    inputBinding:
      prefix: --input_plumed_folder

  output_plumed_folder:
