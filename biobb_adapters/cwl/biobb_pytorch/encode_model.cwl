...
label: Encode data with a Molecular Dynamics AutoEncoder (MDAE) model.

doc: |-
  Evaluates a PyTorch autoencoder from the given properties.

baseCommand: encode_model
...
inputs:
  input_model_pth_path:
    label: Path to the trained model file whose encoder will be used
    doc: |-
      Path to the trained model file whose encoder will be used
      Type: string
      File type: input
  ...
  input_dataset_pt_path:
    label: Path to the input dataset file (.pt) to encode
    doc: |-
      Path to the input dataset file (.pt) to encode
      Type: string
      File type: input
      Accepted formats: pt
  ...
  output_results_npz_path:
    label: Path to the output latent-space results file (compressed NumPy archive,
      typically containing 'z')
    doc: |-
      Path to the output latent-space results file (compressed NumPy archive, typically containing 'z')
      Type: string
      File type: output
