...
def _emref(input_haddock_wf_data, output_haddock_wf_data, refinement_output_zip_path, ambig_restraints_table_path, unambig_restraints_table_path, hb_restraints_table_path, haddock_config_path, properties, **kwargs):
    
    task_config.pop_pmi(os.environ)
    
    try:
        EMRef(input_haddock_wf_data=input_haddock_wf_data, output_haddock_wf_data=output_haddock_wf_data, refinement_output_zip_path=refinement_output_zip_path, ambig_restraints_table_path=ambig_restraints_table_path, unambig_restraints_table_path=unambig_restraints_table_path, hb_restraints_table_path=hb_restraints_table_path, haddock_config_path=haddock_config_path, properties=properties, **kwargs).launch()
...
def em_ref(input_haddock_wf_data, output_haddock_wf_data, refinement_output_zip_path=None, ambig_restraints_table_path=None, unambig_restraints_table_path=None, hb_restraints_table_path=None, haddock_config_path=None, properties=None, **kwargs):
    ...
    if (output_haddock_wf_data is None or (os.path.exists(output_haddock_wf_data) and os.stat(output_haddock_wf_data).st_size > 0)) and \
       ...
       True:
        ...
        _emref(input_haddock_wf_data, output_haddock_wf_data, refinement_output_zip_path, ambig_restraints_table_path, unambig_restraints_table_path, hb_restraints_table_path, haddock_config_path, properties, **kwargs)
