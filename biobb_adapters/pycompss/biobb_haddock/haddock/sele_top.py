...
def _seletop(input_haddock_wf_data, output_haddock_wf_data, output_selection_zip_path, haddock_config_path, properties, **kwargs):
    
    task_config.pop_pmi(os.environ)
    
    try:
        SeleTop(input_haddock_wf_data=input_haddock_wf_data, output_haddock_wf_data=output_haddock_wf_data, output_selection_zip_path=output_selection_zip_path, haddock_config_path=haddock_config_path, properties=properties, **kwargs).launch()
...
def sele_top(input_haddock_wf_data, output_haddock_wf_data, output_selection_zip_path=None, haddock_config_path=None, properties=None, **kwargs):
    ...
    if (output_haddock_wf_data is None or (os.path.exists(output_haddock_wf_data) and os.stat(output_haddock_wf_data).st_size > 0)) and \
       ...
       True:
        ...
        _seletop(input_haddock_wf_data, output_haddock_wf_data, output_selection_zip_path, haddock_config_path, properties, **kwargs)
